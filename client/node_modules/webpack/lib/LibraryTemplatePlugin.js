 ...
 * @param {"amd" | "commonjs" | ***REMOVED***} umdProperty property used when a custom umd object is provided
			...
			switch (this.target) {
				case "var":
					...
					new SetVarMainTemplatePlugin(
						`var ${accessorAccess(undefined, this.name, ***REMOVED***)}`,
						false
					).apply(compilation);
					break;
				case "assign":
					new SetVarMainTemplatePlugin(
						accessorAccess(undefined, this.name, ***REMOVED***),
						false
					).apply(compilation);
					break;
				case "this":
				...
				case "window":
					if (this.name) {
						new SetVarMainTemplatePlugin(
							accessorAccess(this.target, this.name, ***REMOVED***),
							false
						).apply(compilation);
					} else {
