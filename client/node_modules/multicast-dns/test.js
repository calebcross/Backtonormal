...
var configs = [
   {ip: '***REMOVED***', multicast: false}
  // {'interface': '***REMOVED***', multicast: true}
]
...
tests.forEach(function (test) {
  ...
  test('A record', function (dns, t) {
    dns.once('query', function (packet) {
      ...
      dns.respond([{type: 'A', name: 'hello-world', ttl: 120, data: '***REMOVED***'}])
    })

    dns.once('response', function (packet) {
      t.same(packet.answers.length, 1, 'one answer')
      t.same(packet.answers[0], {type: 'A', name: 'hello-world', ttl: 120, data: '***REMOVED***', class: 1, flush: false})
      dns.destroy(function () {
        t.end()
      })
    })
  ...
  test('cache flush bit', function (dns, t) {
    dns.once('query', function (packet) {
      dns.respond({
        answers: [
          {type: 'A', name: 'foo', ttl: 120, data: '***REMOVED***', class: 1, flush: true},
