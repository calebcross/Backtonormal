...
export interface TransformOptions {
    ...
    /**
     * Specify the ***REMOVED*** folder that defines the location to search for "babel.config.js", and the default folder to allow `.babelrc` files inside of.
     *
     * Default: `"."`
     */
    root?: string | null;
    ...
    /**
     * This option, combined with the ***REMOVED*** value, defines how Babel chooses its project root.
     * The different modes define different ways that Babel can process the ***REMOVED*** value to get
    ...
    /**
     * The config file to load Babel's config from. Defaults to searching for "babel.config.js" inside the ***REMOVED*** folder. `false` will disable searching for config files.
     *
     * Default: `undefined`
     */
     ...
     * inside of. Defaults to only searching the ***REMOVED*** package.
     *
     * Default: `(root)`
     */
