...
describe('IP library for node.js', function() {
  ...
  describe('isEqual() method', function() {
    it('should check if addresses are equal', function() {
      assert(ip.isEqual('***REMOVED***', '::7f00:1'));
      assert(!ip.isEqual('***REMOVED***', '::7f00:2'));
      assert(ip.isEqual('***REMOVED***', '::ffff:7f00:1'));
      assert(!ip.isEqual('***REMOVED***', '::ffaf:7f00:1'));
      assert(ip.isEqual('::ffff:***REMOVED***', '::ffff:***REMOVED***'));
      assert(ip.isEqual('::ffff:***REMOVED***', '***REMOVED***'));
    });
  });
  ...
  describe('isPrivate() method', function() {
    it('should check if an address is localhost', function() {
      assert.equal(ip.isPrivate('***REMOVED***'), true);
    });
  ...
  describe('loopback() method', function() {
    describe('undefined', function() {
      it('should respond with ***REMOVED***', function() {
        assert.equal(ip.loopback(), '***REMOVED***')
      });
    });

    describe('ipv4', function() {
      it('should respond with ***REMOVED***', function() {
        assert.equal(ip.loopback('ipv4'), '***REMOVED***')
      });
    });
  ...
  describe('isLoopback() method', function() {
    describe('***REMOVED***', function() {
      it('should respond with true', function() {
        assert.ok(ip.isLoopback('***REMOVED***'))
      });
    });
  ...
  describe('toLong() method', function() {
    it('should respond with a int', function() {
      assert.equal(ip.toLong('***REMOVED***'), 2130706433);
  ...
  describe('fromLong() method', function() {
    it('should repond with ipv4 address', function() {
      assert.equal(ip.fromLong(2130706433), '***REMOVED***');
