...
}, 'failed to connect to "%s:%d"', '***REMOVED***', 215);
...
This outputs:
    ...
    failed to connect to "***REMOVED***:215": something bad happened
    ConnectionError
    { errno: 'ECONNREFUSED', remote_ip: '***REMOVED***', port: 215 }
    ConnectionError: failed to connect to "***REMOVED***:215": something bad happened
...
This outputs:
    ...
    request failed: failed to connect to "***REMOVED***:215": something bad happened
    RequestError
    { errno: 'EBADREQUEST', remote_ip: '***REMOVED***', port: 215 }
    RequestError: request failed: failed to connect to "***REMOVED***:215": something bad happened
