...
* Launch the HTTP server (`npm run serve-tests`) and visit
  * http://***REMOVED***:1336/amd-test
  * http://***REMOVED***:1336/browser-test
  * http://***REMOVED***:1336/browserify-test - **Currently not working** due to a bug with browserify (see [pull request #66](https://github.com/evanw/node-source-map-support/pull/66) for details).
* For `header-test`, run `server.js` inside that directory and visit http://***REMOVED***:1337/
