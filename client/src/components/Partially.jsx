...
function Partially({ title, data }) {
	...
	return (
		<div className='card border-dark my-1 partially stacks'>
			...
			<div className='d-flex justify-content-evenly flex-wrap'>
				<div className='card-body text-center card-inner '>
					<h4 className='card-title .4 monst'>
						{!Administered_Dose1_Recip ? "N/A" : oneDose.toLocaleString()}
					</h4>
				...
				<div className='card-body text-center card-inner'>
					<h4 className='card-title .4 monts'>
						{
							<CountUp
								suffix={"%"}
								decimals={
