...
function Not({ title, data }) {
    ...
    const { Administered_Dose1_Recip, Administered_Dose1_Pop_Pct, Census } = data.entry;
            ...
            <div className='d-flex justify-content-evenly flex-wrap'>
                <div className='card-body text-center '>
                    ...
                    {!Administered_Dose1_Recip
								? 'N/A'
								: (Census - Administered_Dose1_Recip ).toLocaleString()}
                    </h4>
                    ...
                    <h4 className='card-title display-6 monts'>
                            {
								<CountUp
									suffix={"%"}
									decimals={
										(100 -Administered_Dose1_Pop_Pct).toString().length === 2 ? 0 : 1
									}
