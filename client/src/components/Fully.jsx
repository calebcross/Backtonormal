	...
	return (
		<div className='fully'>
			<div className='card border-dark mb-3'>
				<div className='card-header card-header-vcenter'>
				...
				<div className='d-flex justify-content-evenly flex-wrap'>
					<div className='card-body text-center'>
						<h3 className='card-title fw-bold'><strong>2,000,000</strong></h3>
						<p className='card-text '><strong>persons</strong></p>
					</div>
					<div className='card-body text-center'>
						<h3 className='card-title fw-bold'><strong>15.27%</strong></h3>
