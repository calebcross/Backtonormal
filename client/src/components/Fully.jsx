			...
			<div className='card border-dark mb-3'>
				...
				<div className='d-flex justify-content-evenly flex-wrap'>
					<div className='card-body text-center '>
						<h4 className='card-title fw-bold display-6 monts'><strong>{!Series_Complete_Yes ? 0 : Series_Complete_Yes.toLocaleString()}</strong></h4>
						<p className='card-text '><strong>people</strong></p>
					</div>
					<div className='card-body text-center'>
						<h4 className='card-title fw-bold display-6 monts'><strong>{<CountUp suffix={"%"} decimals={!Series_Complete_Yes ? 0 : (Series_Complete_Pop_Pct.toString().length === 2 ? 0 : 1)} end={Series_Complete_Pop_Pct}/>}</strong></h4>
